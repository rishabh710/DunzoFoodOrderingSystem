package com.example.dunzo.Database;
...
public class Database extends SQLiteAssetHelper {
    private static final String DB_NAME="DunzoDB.db";
    ...
    public void addToFavorites(Favorites food){
        ...
        String query= String.format("INSERT INTO Favorites(" +
                ...
                food.getFoodId(), food.getFoodName(),food.getFoodPrice(),food.getFoodMenuId(),food.getFoodImage(),food.getFoodDiscount(),
